...
CURATOR_SYSTEM_PROMPT = (
    ...
    "Track format: show_name/season_folder/episode_identifier for entertainment, "
    "or podcast_name/episode_identifier for podcasts. The episode identifier can "
    "be a number (01, 02), an episode title (Get Schwifty), or a filename stem "
    "(02-05Get Schwifty). The system will search for the best match.\n\n"
...
CURATOR_CHAT_PROMPT = (
    ...
    '{"action": "queue", "tracks": ["ShowName/season NN/episode_identifier", ...], '
    '"reason": "Brief explanation"}\n\n'
    "Track format: show_name/season_folder/episode_identifier for entertainment, "
    "or podcast_name/episode_identifier for podcasts. The episode identifier can "
    "be a number (01, 02), an episode title (Get Schwifty), or a filename stem "
